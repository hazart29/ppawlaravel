  			...
  			<div>
  				<div class="">
  					<div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
                        ...
                        <div class="mb-4">
                            <label for="formNama" class="block text-gray-700 text-sm font-bold mb-2">Nama Matkul :</label>
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="formNama" wire:model="nama_mk">
                            @error('nama_mk') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
						<div class="mb-4">
                            <label for="formSKS" class="block text-gray-700 text-sm font-bold mb-2">SKS :</label>
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="formSKS" wire:model="sks">
  			...
  			<div>
  				<div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
					...
					<table class="table table-striped w-full">
						...
						<tfoot>
							<tr>
								<td class="pt-4" colspan="4">{{ $val_dataMatkul->links() }}</td>
							</tr>
						</tfoot>
					</table>
				</div>
